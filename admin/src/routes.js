...
import AddCategory from './components/List/Category/Category'
...
const Create = React.lazy(() => import('src/components/List/Product/Create.js'))
const View = React.lazy(() => import('src/components/List/Product/View.js'))
